				...
				<div class="inner">
					...
					<h2>LISTA DE PREGUNTADOS</h2>
							...
							<table border="1">
						        ...
						        ?>
						            <tr>
						                <td><a href="preguntadosU.php?id=<?php echo $raw['id_preguntados']; ?>"><?php echo $raw['id_preguntados']; ?></td>
						                <!--td><imput id="idPreguntados" value=<?php #echo $raw['id_preguntados']; ?> > </td-->
						                <!--td><a id="idPreguntados" onclick="capturadDato()"> <?php #echo $raw['id_preguntados']; ?> </td-->
